...
public class Editor {
	...
	public static void render() {
		...
		GUI.window(new Rect(0, Main.window.getHeight()-400, 300, 400), "Asset Types", Editor::test, window);
		GUI.window(new Rect(300, Main.window.getHeight()-400, Main.window.getWidth()-600, 400), "Assets", Editor::test, window);
	}
